...
const musicEvents = [
    ...
    },
    {
        ...
        path: 'jamesblake',
        description: `After a long drought of live performances due to the COVID-19 Pandimic, I was very excited for another concert. James Blake went on tour for his new album 'Friends that Break Your Heart', which I personally really enjoyed. He performed a good range of his own songs, from his Post-Dubstep era, all the way up to his current Electronic R&B music. His visuals were spot on, with LED bars on the side of the stage. His show was all performed live by timing instrumentals, multiple pianos, soundboards, and an electronic drum kit, which was assisted by 2 other members on stage. His vocals sounded amazing, especially when he covered 'Godspeed' by Frank Ocean, which was written by Blake. He finished the show by covering Joni Mitchell's 'A Case of You'. He also brough out Atlanta locals JID and SwaVay to perform frozen together. His opener also brought out Lil Yachty for a guest feature, which makes it only the third time I've seen him live. Overall, it was such a great performance and I'm excited to see him again one day. No rush, James.`,
        openers: ['Fousheé'],
    ...
    },
    {
        ...
        path: 'denzelcurry',
        description: `As I said that Phoebe had the calmest concert I've ever been to, Denzel held the most chaotic show I've ever been to, topping Tyler and Travis. Denzel Curry came to the Tabernacle, which was the perfect size for an artist like him. His openers put on a great set, warming up the audience to what was coming. Once Denzel came out, it was moshpit after moshpit after moshpit. Only two songs didn't contain any moshpits, the first song he performed and the last song. He performed a great mix of his songs, including the newest ones, and some of his older songs. The crowd was so energetic, that halfway through the show, me and a few others lost control of ourselves and nearly fell over. The floor was smeared in drinks and sweat. The show was so chaotic, I didn't get many videos or photos simply because of the fact that the crowd was so dangerous, I didn't want to risk loosing my phone. After Zel's set, he came out with a suprise guest, Kenny Mason, which performed his song stick. When he came out, I was trying to figure out who it was on stage, but as a turned around, there was a moshpit that took up the entire floor, so I went ahead and just lived it out in celebration of such a good night.`,
    ...
    },
    {
        ...
        path: 'pushat',
        description: `Three days after I saw Denzel, I got to see Pusha T. This was the smallest venue I've ever been to, which was great because it made the night feel intimate. I happened to be front row, which gave me perfect opportunites for images as you can see. Pusha T put on such a great show. He ran through nearly most of his new album, "It's almost dry", along with nearly most of his album before 'Daytona'. Push performed songs that went all the way back to when he was in Clipse with his brother. The show wasn't that chaotic, other than a few songs. This was great considering that Pusha T knew all of his lyrics. He had no mistakes, and put all of his effort into this show. Sadly, there were no suprise guests, but I thought it was such a great show considering the ticket only cost $35. I'm considering seeing him again in Octobor simply because of how great the show was.`,
