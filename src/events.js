...
const musicEvents = [
    ...
    }, 
    {
        ...
        path: 'jpegmafia',
        description: `Over the last few years or so, I started getting into JPEGMAFIA’s music. I’ve always found experimental music has had a lasting impression on me. His debut album left a lasting impression on me to dive more into his discography. Sadly, I wasn’t into his music enough around his tour before this show, however I was lucky enough to see him at his own show at the Tabernacle around a year later. I got tickets, and went that night to one of the greatest performances I’ve ever seen. Peggy put his all into this performance. He opened his performance with his song “Jesus Forgive Me”, which perfectly set the vibe for the night. He even performed his own cover of Call Me Maybe by Carly Rae Jepson. The crowd was so energetic through his whole performance, which perfectly reciprocated Peggy’s energy. His opener was The Difference Machine, an Atlanta local, who also put on a great, yet brutal performance. I’m very excited for his next tour.`,
    ...
    }, 
    {
        ...
        thumbnail: require('./images/pushat2/pushatthumbnail.jpg'),
        path: 'pushat2',
        description: `When I saw Pusha T was going on tour again, I knew I had to go, even if it was going to be a replication of his first show. However, for this show, IDK opened for him, and honestly he had such a great performance that you would think it’s his own show. I wasn’t front row for this show, however I still had a lot of fun, as me and my friends moshed to songs that you wouldn’t think would be moshpit worthy, even to his song Grindin from his days in Clipse. After the show, I got the opportunity to meet IDK, who seemed very nice and down to earth. I would highly recommend fans to see Pusha T while they can, he didn’t skip a single lyric this night. He puts in his all.`,
        openers: ['IDK'],
        guests: ['None'],
        images: [require('./images/pushat2/pushat1.jpg'), require('./images/pushat2/pushat2.jpg'), require('./images/pushat2/pushat3.jpg'), require('./images/pushat2/pushatgif1.gif'), require('./images/pushat2/pushat4.jpg'), require('./images/pushat2/pushat5.jpg'), require('./images/pushat2/pushatgif2.gif'), require('./images/pushat2/pushat6.jpg'), require('./images/pushat2/pushat7.jpg'), require('./images/pushat2/pushat8.jpg'), require('./images/pushat2/pushatgif3.gif')]
    },
    {
        name: 'Turnstile',
        date: 'November 14th, 2022',
        venue: 'Coca-Cola Roxy',
        thumbnail: require('./images/turnstile/turnstilethumbnail.jpg'),
        path: 'turnstile',
        description: `After the last Pusha T show, my friends told me and invited me to go see Turnstile. I never really heard a Turnstile song around this time, however I am very thankful for the invite, as this was an unforgettable night. Teezo Touchdown opened first, and he put on a fun, energetic performance. Then Snail Mail did her part for the night by giving a calm experience. However, when Turnstile came on, the crowd got so hyped as I went from row thirty or so, all the way to row 5 within 10 seconds. I’ve never been to a hardcore punk show, so this was a first experience, and I had no clue I was going to experience this. They opened their show with “Holiday”, which set the tone for the entire night. It has consistent endless mosh pits and crowd surfings. I am so happy I got to experience this artist live, even considering I got kicked in the face about two or three times, I’m excited for the next tour.`,
        openers: ['Teezo Touchdown', 'Snail Mail'],
        guests: ['None'],
        images: [require('./images/turnstile/turnstile1.jpg'), require('./images/turnstile/turnstilegif1.gif'), require('./images/turnstile/turnstile2.jpg'), require('./images/turnstile/turnstilegif2.gif'), require('./images/turnstile/turnstile3.jpg'), require('./images/turnstile/turnstilegif3.gif'),]
    },
    {
        name: 'JID & Smino', 
